const SIZES = [
  ...
  const keySound = new Audio("https://manzdev.github.io/twitch-manzdev-bios/assets/key.mp3");
  ...
  const sound = new Audio("https://manzdev.github.io/twitch-manzdev-bios/assets/boot.mp3");
  ...
  class AwardBoot extends HTMLElement {
    ...
    turnOn() {
      return this.setHTML(".header", `
        <img class="epa" src="https://manzdev.github.io/twitch-manzdev-bios/assets/epa.png" alt="Energy EPA">
        <div class="brand-text">
          <img class="ribbon" src="https://manzdev.github.io/twitch-manzdev-bios/assets/award-logo.png" alt="Award Logo">
            <p>
    ...
    enterBIOS() {
      const monitor = document.querySelector(".bios_startup");
