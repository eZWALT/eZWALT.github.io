...
function start() {
    ...
    function cmd_pwd() {
        ...
        link.innerText = "https://eZWALT.github.io\n";
        link.href = "https://eZWALT.github.io";
        link.tabIndex = -1;
        output_html(link);
    }
    ...
    link.href = "mailto:waltertv02@gmail.com";
    link.target = "_blank";
    link.tabIndex = -1;
    FILES["email"] = link;

    var link = document.createElement("a");
    link.innerText = "My CV.pdf\n";
    link.href = "./docs/cv.pdf";
    // link.onclick="showWindow('cv_box')" TODO: make the cv window appear
    link.target = "_blank";
    link.tabIndex = -1;
    FILES["cv"] = link;

    var link = document.createElement("a");
    link.innerText = "github.com/eZWALT\n";
    link.href = "https://github.com/eZWALT";
    link.target = "_blank";
    link.tabIndex = -1;
    FILES["github"] = link;

    var link = document.createElement("a");
    link.innerText = "linkedin.com/in/walterjtv/\n";
    link.href = "https://www.linkedin.com/in/walterjtv/";
    link.target = "_blank";
    link.tabIndex = -1;
    FILES["linkedin"] = link;
    ...
    p.innerText = "You should be really proud (or really concerned) of yourself, for reaching this easter egg!";
    about.appendChild(p);

    p = document.createElement("p");
    p.innerText = "Or maybe you just stumbled over upon and have no clue of what you are doing :) ";
    about.appendChild(p);

    p = document.createElement("p");
    p.innerText = "I would want to grateful and thank you all:";
    about.appendChild(p);

    var ul = document.createElement("ul");
    var li = document.createElement("li")
    li.innerText = "Miquel Torner Vinyals, a fellow friend from college (miqueltv on likedin) \n for creating the whole base for this awesome linux web terminal";
    ul.appendChild(li);
    li = document.createElement("li")
    li.innerText = "You, for your time & interest on me";
    ul.appendChild(li);
